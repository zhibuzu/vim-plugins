...
function! <SID>GetDoxFileHeader(leading_blank)
  ...
  let doc = doc. a:leading_blank."/***************************************************************************\n"
	let doc = doc. a:leading_blank." * \n"
  let doc = doc. a:leading_blank." * Copyright (c) ".<SID>GetYear()." hulifa.cn, Inc. All Rights Reserved\n"
...
function! <SID>GetPyDocFileHeader(leading_blank)
    ...
    let doc = doc. a:leading_blank."\"\"\"\n"
    let doc = doc. a:leading_blank."File: ".<SID>GetFileName()."\n"
    let doc = doc. a:leading_blank."Author: ".<SID>GetUserName()."(".<SID>GetUserName()."@gmail.com)\n"
    let doc = doc. a:leading_blank."Date: ".<SID>GetDate()."\n"
    let doc = doc. a:leading_blank."\"\"\"\n"
    return doc
endfunction
...
autocmd BufNewFile *.php :call <SID>InsertPHPFormat()
